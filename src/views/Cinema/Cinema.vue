						...
						<div class="cinema-info-rt cinema-info">
							<div class="">
								<span class="cinema-lowPrice price-fmt"
									><i>￥</i>
									<span class="interge" style="font-size: 15px">{{ item.lowPrice | money1}}</span>
									<span class="decimal" style="font-size: 10px"></span>
									<span class="decimal" style="font-size: 10px;"
										>{{item.lowPrice | money2}}</span
									>
								</span>
