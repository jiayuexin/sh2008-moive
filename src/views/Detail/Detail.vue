                        ...
                        <div>
                            <ul style="margin-left:15px">
                                <Swiper :key="'photos' + film.photos.length">
                                    <li
                                        v-for="(items, indexs) in film.photos"
                                        :key="indexs"
                                    ...
                                    >
                                        <div class="lazy-img">
                                            <div
                                                class="lazy-img-wrap"
                                                style="width: 150px; height: 100px; background: rgb(249, 249, 249); opacity: 1; display: block;"
                                            >
                                                <img
                                                    :src="items"
                                                    class="target-img"
