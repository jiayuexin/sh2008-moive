            ...
            <div class="center-view">
                <div class="avatar">
                    <img
                        ...
                        class="avator-icon"
                    />
                    <img v-else :src="userInfo.headIcon" class="avator-icon" />
                    <div v-if="userInfo.userId" class="nick-name">
                        {{ userInfo.mobile }}
                    </div>
                    <div v-else class="nick-name" @click="login()">
                        立即登录
                    </div>
                </div>
...
import Vue from "vue";
import { ShareSheet, Toast, Cell } from "vant";
